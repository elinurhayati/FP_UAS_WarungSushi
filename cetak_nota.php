		...
		<div class="slidebar">
			...
			<ul class="nav">
				...
				<li>
					...
					<a href="cetak_nota.php" class="active">
						<!--Icon Nav-->
		...
		<div class="home-content">
			<div class = "container_signup">
				...
				<table class = "table_order">
					...
					<tbody method="GET">
						<?php 
						//query untuk menampilkan data di tabel pesanan
						...
						while ($row = mysqli_fetch_array($show)){
							...
							echo "<td>";
				            //Mengarahkan button delete ke laman proses_cetak.php
							echo "<a href='proses_cetaknota.php?id=".$row['id']."' class= 'btn_hapuskasir'>CETAK</a>";
							echo "</td>";
							echo "</tr>";
						}
						?>
