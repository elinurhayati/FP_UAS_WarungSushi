...
<head>
	...
	<style type="text/css">
		...
		/*Format tampilan ketika kursor diarahkan ke class btndonat*/
		.btndonat:hover{
			background-color: #900c3f;
			color: white;
		}
				...
				<ul>
					<li>
						<a>
							...
							<button class="btnbar" name="btnbar" onclick="window.location='bar.php';">Bar Chart</button>
						</a>
						<a>
						...
						data: {
							...
							datasets: [{
								label: 'Jumlah Produk Terjual',
								 // Memanggil variabel jumlah_produk yang akan dijadikan isi chart
								data: <?php echo json_encode($jumlah_produk); ?>,
								//Mengatur warna background dari bar
								backgroundColor: 'rgba(52, 86, 139, 0.3)',
								//Mengatur warna border dari bar
								borderColor: 'rgba(52, 86, 139, 1)',
								//Mengatur lebar border dari border bar
								borderWidth: 2
							}]
						},
